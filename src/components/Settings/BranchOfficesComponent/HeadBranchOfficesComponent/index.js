...
const HeadBranchOfficesComponent = () => {
	...
	const { branch_offices_text } = useTranslation()
		...
		<Root>
			...
			<ContentContainer>
				<ETASimpleText
					...
					align='left'>
					{branch_offices_text.charAt(0).toUpperCase() + branch_offices_text.slice(1)}
				</ETASimpleText>
			</ContentContainer>
		</Root>
	)
...
export default React.memo(HeadBranchOfficesComponent)
