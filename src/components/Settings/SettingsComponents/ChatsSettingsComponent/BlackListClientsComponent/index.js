...
const BlackListClientsComponent = ({ getDataRequest, data }) => {
...
const BlackListClientsComponentConnect = connect(
	mapStateToProps,
	mapDispatchProps,
)(BlackListClientsComponent)

export default BlackListClientsComponentConnect
