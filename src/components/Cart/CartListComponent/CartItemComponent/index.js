...
const CartItemComponent = ({propitem}) => {
  const themeContext = useContext(ThemeContext);
  const [addedCounter, setaddedCounter] = useState(propitem.howMany);
      ...
      <Item>
        ...
        <CartItemData>
          <CartItemHeadContainer>
            ...
            <CardItemFunctions>
              <Touchable onPress={() => _removeItemCart(propitem._id)}>
                <Ionicons
                  name="md-close"
                  size={18}
                  color={themeContext.SECONDARY_TEXT_BACKGROUND_COLOR}
          ...
          <CartItemContainer>
            ...
            <CartItemRightContainer>
              <AddCartContainer>
                {addedCounter === 0 ? (
                  <AddCart onPress={() => _addCart(propitem)}>
                  ...
                  <AddRemoveContainer>
                    <RemoveCart onPress={() => _removeCart(propitem._id)}>
                      <AddRemoveButtonContainer>
                        {/* <CounterContainer> */}
                        <ETASimpleText
                          size={22}
